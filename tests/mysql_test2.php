<?php
    ...
    insert_teste('10', 'bom', 1, date('Y-m-d H:i:s'), date('Y-m-d H:i:s'));
    insert_teste('10', 'bom', 2, date('Y-m-d H:i:s'), date('Y-m-d H:i:s'));
    insert_teste('9', 'bom', 3, date('Y-m-d H:i:s'), date('Y-m-d H:i:s'));
    buscar_teste();
